require "spec_helper"
RSpec.describe TextareaComponent do
  # NOTE: These tests are identical to TextFieldComponent's tests, save for one line
  context "label" do
    ...
    it "wraps it in a div and sets an id when the label is an id: hash and omits the label text" do
      ...
      inputs = html.css("textarea[id='foobar']") # <-- this line is different in TextFieldComponent
