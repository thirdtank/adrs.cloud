 ...
 *                                                             style UI.
 *
 * @fires BrutTabs#tabselected whenever the tab selection has changed
 * @example
 * <brut-tabs>
 ...
 *   <h3>Inbox</h3>
 * </section>
 * <section role="tabpanel" tabindex="-1" id="drafts-panel" hidden>
 *   <h3>Drafts</h3>
 * </section>
 ...
 *
 */
class BrutTabs extends BaseCustomElement {
  ...
  #setTabAsSelected(selectedTab, { skipPushState = false } = {}) {
    this.#tabs().forEach( (tab) => {
      ...
      if (tab == selectedTab) {
        ...
        this.dispatchEvent(new CustomEvent("tabselected", { tabId: tab.id }))
      }
      else {
