                ...
                try {
                  ...
                  Array.from(errorMessages).map( (element) => {
                    ...
                    if (object.messagesElement) {
                      object.form = object.messagesElement.closest("form")
                    }
                    return object
                  }).map( (object) => {
                    if (object.inputName && object.form) {
                      object.input = object.form.elements.namedItem(object.inputName)
                    }
                    return object
                  }).forEach( ({element,inputName,messagesElement,form,input}) => {
                    if (input) {
