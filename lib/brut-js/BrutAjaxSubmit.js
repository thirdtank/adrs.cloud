  ...
  #submitForm(form, firstSubmittedAt, numAttempts) {
    ...
    fetch(request).then( (response) => {
      if (response.ok) {
        ...
        form.querySelectorAll(`${BrutConstraintViolationMessage.tagName}[key='general.cv.fe.general']`).forEach( (e) => e.setAttribute("hidden",true) )
              ...
              response.text().then( (text) => {
                ...
                try {
                  ...
                  for (const [inputName, {input, messagesElement, errorMessages}] of Object.entries(inputsToMessages)) {
                    ...
                    form.querySelectorAll(`${BrutConstraintViolationMessage.tagName}[key='general.cv.fe.general']`).forEach( (e) => e.removeAttribute("hidden") )
                  }
