...
RSpec.describe "Manage Projects" do
  ...
  it "can add, edit, and archive projects" do
    ...
    submit_button = page.locator("form button[title='#{t("pages.NewProjectPage.new_project")}']")
    submit_button.click
    ...
    submit_button = page.locator("form button[title='#{t("pages.EditProjectByExternalIdPage.save_project")}']")
